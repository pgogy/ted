<?PHP
	...
	$movie = $ted_engine->createnewswf(($ted_engine->page_index[count($ted_engine->page_index)-1])+1,1.0,$_POST['height'],$_POST['width'],$r,$g,$b);
