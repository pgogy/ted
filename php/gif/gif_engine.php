<?
	...
	class gif_engine{
			...
			var $score_button;
			var $correct_values;
			var $flashcard_backup;
			var $flashcard_answer;
			var $wfp_answer;
			var $skip_create;
			...
			function set_gif_options($frames,$rate,$height,$width,$r,$g,$b){

				$this->number_of_pages = $frames;
				$this->gif_rate = $rate;
				$this->gif_width = $width;
				$this->gif_height = $height;
				$this->gif_bgcolour_r = $r;
				$this->gif_bgcolour_g = $g;
				$this->gif_bgcolour_b = $b;
				$this->page_counter = 0;
				$this->curr_image = imagecreatetruecolor($width,$height);
				$colour = imagecolorallocate($this->curr_image,$r,$g,$b);
				imagefill($this->curr_image,0,0,$colour);

			}
			
			function insert_picture($arguments){
				...
				imagecopyresampled($this->curr_image, $image_to_scale, $arguments[2], $arguments[3], 0, 0, $arguments[4], $arguments[5], $array[0], $array[1]);
			...
			function placetext($str,$x,$y,$colour,$width,$height,$font_size,$font){
				
				imagettftext($this->curr_image, $font_size, 0, $x, $y, $colour, $font, $str);
